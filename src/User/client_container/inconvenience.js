...
const LinkStyled = styled(Link)`
  ...
  color: black;
`;
const WriteReportButton = styled.button`
    padding : 3px;
...
const InconfidencePage = () => {
    ...
    return (
        <div>
            ...
            <ContentBlock>
                <ContentTitle>불편사항</ContentTitle>
                <SecondWrapper>
                    <WriteReportButton>글쓰기</WriteReportButton>
                    <TitleFliterBlock>
...
export default InconfidencePage;
